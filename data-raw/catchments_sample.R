...
benchmark_table_sample <- tibble(
  "PB_0001" = as.integer(c(187888,187919,187948,187979,187996,191104,191141,191161,191332,191337,191369,191396,191525,191560,191635,196520, NA, NA, NA, NA, NA, NA, NA, NA)), # overlaps with PB_0003 but not PB_0002
  "PB_0002" = as.integer(c(188154,188278,192553,192941,193106,197231,198355,198628,198632,199226,199255,199260,199265,199292,199362,199367,199372,199662,199667,199703,199708,199717, NA, NA)), # overlaps with PB_0003 but not PB_0001
  "PB_0003" = as.integer(c(187979,187996,188057,191396,191525,191576,191625,191649,191838,191890,191951,191960,191982,191987,192941,199226,199237,199243,199251,199255,199357,199362,199367,199372)) # overlaps with both PB_0001 and PB_0002
  )
