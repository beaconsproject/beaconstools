...
By ordering the benchmarks by the number of gaps we can see that six benchmarks have just one representation gap. PA_1 has three gaps. Since no benchmarks pass all of our required targets we will now combine multiple benchmarks into networks to try and meet all targets.
